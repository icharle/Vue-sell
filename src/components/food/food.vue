    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <Ratingselect :selectType="selectType" :desc="desc" :onlyContent="onlyContent"
                        :ratings="food.ratings" @select="selectRating"
                        @switchOnlyContent="toggleContent"></Ratingselect>
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-for="(rating, index) in food.ratings" v-show="needShow(rating.rateType,rating.text)"
                ...
                <p class="text">
                  <span :class="rating.rateType===0 ? 'icon-thumb_up' : 'icon-thumb_down'">
                    {{rating.text}}
                  </span>
                </p>
              </li>
