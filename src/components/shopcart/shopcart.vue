  ...
  <div>
    <div class="shopcart">
      ...
      <div class="ball-container">
        <transition name="drop" v-for="(ball, index) in balls" :key="index" @before-enter="beforeDrop" @enter="dropping"
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    computed: {
      totalPrice() {
        return this.selectFoods.reduce(function (total, food) {
          return total + food.price * food.count
        }, 0)
      },
      totalCount() {
        return this.selectFoods.reduce((preTotal, food) => {
